      ...
      icon: (
        <svg width="72" height="72">
          <g fill-rule="nonzero" fill="none">
            <circle fill="#FFF2F4" cx="36" cy="36" r="36"></circle>
            <g opacity="0.9">
              <path
              ...
              ></path>
              <path
                d="M23.018 53.97a4.8 4.8 0 010-9.601h26.397c.116 0 .23 0 .343.013h.209a4.258 4.258 0 004.25-4.243v1.834c0 1.379-.593 2.69-1.629 3.6a4.801 4.801 0 01-3.173 8.4l-26.397-.004z"
                fill="#E16364"
              ></path>
              <path
              ...
              <path
                fill="#E77071"
                d="M23.621 15.974h1.601v28.44h-1.601z"
              ></path>
              <path
      ...
      icon: (
        <svg width="72" height="72">
          <g fill="none" fill-rule="evenodd">
            ...
            <g stroke-linecap="round" stroke="#2CC3BE" stroke-width="2">
              <path d="M53.954 30.736h-9.403M53.954 34.914h-9.403M53.954 39.093h-9.403"></path>
            </g>
        ...
        <svg width="72" height="72">
          <g fill="none" fill-rule="evenodd">
            ...
            <path
              ...
              fill-rule="nonzero"
            ></path>
            <g transform="translate(19.158 19.162)" fill-rule="nonzero">
              <rect
                fill="#FFF"
                x="20.406"
                y="22.731"
  ...
  return (
    <div className="landing-tools-container">
      <div className="container">
        <h2 className="roboto-bold landing-tools-header">Our PTE Test</h2>
        <div className="roboto-light landing-tools-sub-header">
          Our PTE test ranges from basic speaking and tests to expert level
          monitoring
        </div>
        <div className="landing-offer-tools">
          {studyTools.map((st, index) => {
            return (
              <div className="st-box" key={index}>
                <div className="st-icon">{st.icon}</div>
                <div className="st-info">
                  <div className="roboto-bold st-title">{st.name}</div>
                  <div className="roboto-light st-detail">{st.detail}</div>
                </div>
              </div>
            );
          })}
